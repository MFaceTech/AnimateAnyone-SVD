...
from svd_poseguider.schedulers.scheduling_euler_discrete_karras_fix import EulerDiscreteScheduler
...
class StableVideoDiffusionPipelineOutput(BaseOutput):
    r"""
    Output class for zero-shot text-to-video pipelines.
...
class StableVideoDiffusionPipelineControlNet(DiffusionPipeline):
    ...
    def __call__(
        ...
        r"""
        The call function to the pipelines for generation.
        ...
        Args:
            ...
            callback_on_step_end_tensor_inputs (`List`, *optional*):
                ...
                `._callback_tensor_inputs` attribute of your pipelines class.
